...
PINNED_SURFACE: dict[str, dict[str, set[str]]] = {
    "core": {
        "Application": {
            "get",  # static
            "userInterface", "activeProduct", "activeDocument", "activeViewport",
            "documents", "version", "log",
            "registerCustomEvent", "fireCustomEvent", "unregisterCustomEvent",
        },
        ...
        "ViewOrientations": {
            "FrontViewOrientation", "BackViewOrientation",
            "LeftViewOrientation", "RightViewOrientation",
            "TopViewOrientation", "BottomViewOrientation",
            "IsoTopRightViewOrientation", "IsoTopLeftViewOrientation",
            "IsoBottomRightViewOrientation", "IsoBottomLeftViewOrientation",
        },
        "CameraTypes": {
            "OrthographicCameraType", "PerspectiveCameraType",
            "PerspectiveWithOrthoFacesCameraType",
        },
        "SaveImageFileOptions": {
            "create",  # static
            "filename", "width", "height",
            "isBackgroundTransparent", "isAntiAliased",
        },
        "Documents": {"add", "open", "item", "itemByName", "count"},
        "Document": {
            "name", "isActive", "isModified", "isSaved", "dataFile", "product",
            "save", "saveAs", "close",
        },
        ...
        "Viewport": {
            "camera", "width", "height", "refresh",
            "saveAsImageFile", "saveAsImageFileWithOptions",
        },
        "Camera": {
            "cameraType", "eye", "target", "upVector", "viewOrientation",
            "perspectiveAngle", "getExtents", "setExtents",
    ...
    "fusion": {
        "Design": {
            ...
            "designType", "unitsManager", "fusionUnitsManager", "timeline",
            "rootComponent", "userParameters", "modelParameters",
            "exportManager", "computeAll", "recomputedFeatureCount",
        },
        "DesignTypes": {"ParametricDesignType", "DirectDesignType"},
        "DistanceUnits": {
            "MillimeterDistanceUnits", "CentimeterDistanceUnits",
            "MeterDistanceUnits", "InchDistanceUnits",
        },
        "MeshRefinementSettings": {
            "MeshRefinementLow", "MeshRefinementMedium", "MeshRefinementHigh",
        },
        "ExportManager": {
            "createSTEPExportOptions", "createIGESExportOptions",
            "createFusionArchiveExportOptions", "createOBJExportOptions",
            "createSTLExportOptions", "createPDFExportOptions", "execute",
        },
        ...
        "Component": {
            "name", "sketches", "features", "bodies", "occurrences",
        },
        ...
        "BRepBody": {
            "name", "volume", "isSolid", "isVisible", "material", "boundingBox",
        },
